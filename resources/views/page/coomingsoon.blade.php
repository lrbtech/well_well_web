...
<html lang="en">
  <head>
    ...
    <title>WellWell CoomingSoon</title>
    <!-- Google font-->
  ...
  <body>
    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid p-0">
        <div class="comingsoon auth-bg-video">
          <video class="bgvideo-comingsoon" id="bgvid" poster="/assets/app-assets/images/other-images/coming-soon-bg.jpg" playsinline="" autoplay="" muted="" loop="">
            <source src="/assets/app-assets/video/auth-bg.mp4" type="video/mp4">
          </video>
          <div class="comingsoon-inner text-center"><img src="/assets/images/logo.png" alt="">
    ...
    <!-- Plugins JS start-->
    <script src="/assets/app-assets/js/countdown.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
