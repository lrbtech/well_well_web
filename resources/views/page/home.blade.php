                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 aos-init" data-aos="fade-right" data-aos-delay="">
                            <div class="single-cat text-center mb-50">
                                ...
                                <div class="cat-cap">
                                    <h5>24/7 SUPPORT</h5>
                                    <p>Our logistic and technical support is always here to help you fulfill your needs and inquiries 24 hours, 7 days a week. Feel free to contact us anytime you need help with your shipment, or even with a simple question,
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="single-cat text-center mb-50">
                                ...
                                <div class="cat-cap">
                                    ...
                                    <p>With our advanced delivery fleet and professional dispatchers, we took to ourselves the responsibility of delivering your goods always on time by using all the technology available in the market, from our state-of-art
                                        dispatching system to our unique driver‘s training program.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 aos-init" data-aos="fade-left" data-aos-delay="">
                            <div class="about-caption mb-50">
                                ...
                                <div class="section-tittle mb-35">
                                    <span>ABOUT US</span>
                                    <h2>WE ARE WELL WELL</h2>
                                </div>
                                <p>We believe that our customer’s success is our secret to success</p>
                                <p>Our main target at <strong>WELL WELL Express</strong> is to provide a wide range of flexible solutions that will satisfy all different requirements in term of domestic shipping, international shipping, and all other logistic
                                    services as well as providing customer support to improve our customer’s business and help them to grow via our highly trained team of professional experts in all different logistic services that you may need.</p>
                                <p style="text-align: justify;">As for our customers who don’t hold an account at
                                    <strong>WELL WELL
                                        Express</strong>, we have a set of specially designed solutions to meet their requirements in both domestic and international shipping.
                                </p>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="home-blog-single">
                                    ...
                                    <div class="blog-caption">
                                        <h4>WELLDOM service</h4>
                                        <p mb-0>Designed for a full range of domestic shipping solutions</p>
                            ...
                            <div class="swiper-slide">
                                <div class="home-blog-single">
                                    ...
                                    <div class="blog-caption">
                                        <h4>WELLPREMIUM service</h4>
                                        <p mb-0>Building solutions according to customers needs.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12 our-info-area bg-transparent" data-aos="fade-left" data-aos-delay="">
                        ...
                        <div class="single-info mb-4">
                            ...
                            <div class="info-caption">
                                <p>Opening Hours</p>
                                <span>Saturday - Thursday 8am to 6pm</span>
                            </div>
                        </div>
