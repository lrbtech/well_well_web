            ...
            <div class="wrap-login100">
                ...
                @csrf
                    ...
                    <div class="wrap-input100 validate-input">
                        <input id="email" type="email" placeholder="Enter Email or Mobile" class="input100 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
