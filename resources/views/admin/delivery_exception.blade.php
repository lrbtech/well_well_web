            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2>{{$language[89][Auth::guard('admin')->user()->lang]}}
                    <span>{{$language[81][Auth::guard('admin')->user()->lang]}}
                    </span></h2> 
...
$('.delivery-exception').addClass('active');
  ...
  $.ajax({
    ...
    success: function(data)
    {
        ...
        if (is_chrome) {
            ...
            mywindow.print(); 
            mywindow.close();
            window.location.href="/admin/delivery-exception";
            }, 250);
        } else {
            mywindow.focus(); 
            mywindow.print(); 
