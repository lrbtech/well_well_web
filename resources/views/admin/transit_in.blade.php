    ...
    <div class="page-header">
      <div class="row">
        <div class="col-lg-6 main-header">
          <h2>{{$language[84][Auth::guard('admin')->user()->lang]}} <span>{{$language[85][Auth::guard('admin')->user()->lang]}}  </span></h2> 
  ...
  $.ajax({
    ...
    success: function(data)
    {
        ...
        if (is_chrome) {
            ...
            mywindow.print(); 
            mywindow.close();
            window.location.href="/admin/transit-in";
            }, 250);
        } else {
            mywindow.focus(); 
            mywindow.print(); 
