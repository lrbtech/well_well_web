              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    @if($role_get->vehicle_type_create == 'on')
                    <button id="add_new" style="width: 200px;" type="button" class="btn btn-primary add-task-btn btn-block my-1">
                    <i class="bx bx-plus">Create Type</i>
                    <span></span>
                    </button>
                    @endif
    ...
    <div class="modal-content">
        ...
        <div class="row">
            <div class="form-group col-md-12">
              ...
              <input autocomplete="off" type="text" id="vehicle_type" name="vehicle_type" class="form-control">
            </div>
        </div>
...
function Delete(id,status){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/delete-vehicle-type/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
