            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2>{{$language[87][Auth::guard('admin')->user()->lang]}} <span>{{$language[88][Auth::guard('admin')->user()->lang]}}  </span></h2> 
...
$('.ready-for-delivery').addClass('active');
...
var orderPageTable = $('#datatable').DataTable({
    ...
    //"pageLength": 50,
    "ajax":{
        "url": "/admin/get-ready-for-delivery",
        "dataType": "json",
        "type": "POST",
  ...
  $.ajax({
    ...
    success: function(data)
    {
        ...
        if (is_chrome) {
            ...
            mywindow.print(); 
            mywindow.close();
            window.location.href="/admin/ready-for-delivery";
            }, 250);
        } else {
            mywindow.focus(); 
            mywindow.print(); 
