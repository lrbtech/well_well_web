        ...
        <div class="page-body">
            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2>Guest Generate <span>Invoice</span></h2> 
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <form action="/admin/excel-guest-generate-invoice" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
...
$('.guest-generate-invoice').addClass('active');
...
var orderPageTable = $('#datatable').DataTable({
    ...
    //"pageLength": 50,
    "ajax":{
        "url": "/admin/get-guest-generate-invoice/1/1",
        "dataType": "json",
        "type": "POST",
...
$('#search').click(function(){
    ...
    var new_url = '/admin/get-guest-generate-invoice/'+fdate+'/'+tdate;
    orderPageTable.ajax.url(new_url).load();
    //orderPageTable.draw();
});
...
function GenerateInvoice(id){
    ...
    if (r == true) {
        $.ajax({
            url : '/admin/create-guest-generate-invoice',
            type: "POST",
            dataType: "JSON",
